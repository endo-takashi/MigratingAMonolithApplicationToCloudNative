...
** link:sessions/day_01/session_01/lab_01a/lab_01a_boot_getting_started.adoc[Lab 1a - Getting Started with Spring Boot]
** link:sessions/day_01/session_01/lab_01b/lab_01b_boot_with_jetty.adoc[Lab 1b - Deploying a Web Application with an Embedded Container]
** link:sessions/day_01/session_01/lab_01c/lab_01c_boot_properties.adoc[Lab 1c - Externalizing Configuration with Spring Boot]
** link:sessions/day_01/session_01/lab_01d/lab_01d_boot_actuator.adoc[Lab 1d - Introspection, Monitoring, and Metrics using Spring Boot Actuator]
* Session 2 (link:sessions/day_01/session_02/session_02.pdf[Slides])
** link:sessions/day_01/session_02/lab_02a/lab_02a_cf_push.adoc[Lab 2a - From Zero to Pushing Your First Application]
** link:sessions/day_01/session_02/lab_02b/lab_02b_cf_service.adoc[Lab 2b - Binding to Cloud Foundry Services]
** link:sessions/day_01/session_02/lab_02c/lab_02c_cf_scaling.adoc[Lab 2c - Scaling Applications]
** link:sessions/day_01/session_02/lab_02d/lab_02d_cf_monitoring.adoc[Lab 2d - Monitoring Applications]
* Session 3 (link:sessions/day_01/session_03/session_03.pdf[Slides])
** link:sessions/day_01/session_03/lab_03a/lab_03a_rest.adoc[Lab 3a - Build a Hypermedia-Driven RESTful Web Service with Spring Data REST]
