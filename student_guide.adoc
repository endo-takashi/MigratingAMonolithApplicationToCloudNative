...
$ git clone https://bitbucket.org/caxqueiroz/springtrader-monolith/
$ git fetch --all

$ git clone https://github.com/viniciusccarvalho/springtrader.git
$ git fetch --all
...
** link:sessions/day_01/session_05/lab_11/lab_11.adoc[Lab 11 - Build an Account Service using MySQL]
** link:sessions/day_01/session_05/lab_12/lab_12.adoc[Lab 12 - Build a Portifolio Service with MySQL]
** link:sessions/day_01/session_05/lab_13/lab_13.adoc[Lab 13 - Build a Quotes Service with Gemfire]
