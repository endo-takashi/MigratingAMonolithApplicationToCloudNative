...
. It is now time to create a user-provided service representing the config server. You can use the `cf cups` command for that. `cf cups` is a shortcut for `cf create-user-provided-service`.
+
----
