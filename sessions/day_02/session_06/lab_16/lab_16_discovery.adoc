...
+
----
$ cd $COURSE_HOME/day_02/session_06/lab_16/initial/springtrader-eureka
----
+
...
+
----
$ cd $COURSE_HOME/day_02/session_06/lab_16/initial/springtrader-producer
----
+
and import the project (via `pom.xml`) into your IDE of choice.
...
. A completed `springtrader-config-server` project has been placed in `$COURSE_HOME/day_02/session_06/lab_15/complete/springtrader-config-server` for your convenience.
In a different terminal window, change to that directory, rebuild, and run the application:
+
----
$ cd $COURSE_HOME/day_02/session_06/lab_15/complete/springtrader-config-server
$ mvn package
