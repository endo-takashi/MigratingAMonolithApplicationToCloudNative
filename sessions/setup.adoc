...
. Create a file on your desktop called "json.reg".  Right click and select edit.  Copy and paste the following:
+
```
...
. Save and close.  Double click on the `json.reg` to run it.  You will get a warning, click `Yes` to continue.
