...
. Create the package `io.springtrader.quotes.services` and in that package create the class `QuoteService`. Paste the following code and add appropriate imports:
+
----
@Service
...
. Access the application at http://localhost:8086/quote/msft. You should see the below:
+
----
