...
. Access the application at the random route provided by CF (such as `http://quotes-undespising-lenition.cfapps.io/accounts/1`). The output should be the same as when run locally:
+
[source,json]
----
{
