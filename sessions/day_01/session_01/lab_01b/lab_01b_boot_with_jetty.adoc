...
. Change to the lab directory (or continue to build off of lab_01a):
+
----
$ cd $COURSE_HOME/day_01/session_01/lab_01b/initial/hello-spring-boot
----
...
----
$ mvn package
$ java -jar target/lab_01b-hello-spring-boot-0.0.1-SNAPSHOT.jar
----
+
