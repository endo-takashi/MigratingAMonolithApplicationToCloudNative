...
. Next we'll add Spring Cloud and MySQL dependencies to our maven pom file. Just after the dependency declaration for +h2+ line add add the following in the +dependencies+ section:
+
[source,xml]
----
